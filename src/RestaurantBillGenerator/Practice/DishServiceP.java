...
//4- Dish objeleri ile ilgili işlemler bu classın amacı
public class DishServiceP {

    //5- Yiyecekleri bir listeye koyalım

    private List<Dish> dishList = new ArrayList(); // oluşturduğumuz class'ı data tipi olarak kullandık.

    //5a- Yiyecekleri oluşturup listeye ekleme
