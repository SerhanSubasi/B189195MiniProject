...
//Yeni özellikler ileride eklenebilsin diye class class oluştururuz. Her class tek bir amaca yönelik olmalıdır.
// 1- Bilet rezervasyonu yapacağımız bir otobüse ihtiyacımız var.
        Bus bus = new Bus("34 ASD 789"); //
...
start(bus,bilet);
    ...
    private static void start(Bus bus, Ticket bilet) {
        ...
        do {
            System.out.println("* Bilet Rezervasyon Sistemine Hoş Geldin Panpa *");
            ...
            System.out.println("Tekli koltuk ücreti %20 daha fazladır ancak çooook rahattır.");
            System.out.println(bus.seats);  // mevcut koltuk noları: "1", "2", .... "32"
            String seat = inp.next();

            //seçilen koltuk no listede var mı veya rezerve edilmiş mi?
...
select= inp.nextInt();
        ...
        System.out.println("Sistemden ayrıldınız, iyi günler dileriz");
